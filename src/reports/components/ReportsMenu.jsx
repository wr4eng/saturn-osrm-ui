...
const ReportsMenu = () => {
  ...
  const buildLink = (path) => {
    ...
    // route-snap - trip-snap
    if (
      path === '/reports/chart' ||
      path === '/reports/route' ||
      path === '/reports/route-snap' ||
      path === '/reports/replay-snap' ||
      path === '/replay'
    ) {
    ...
    <>
      ...
      <List>
        ...
        <MenuItem
          ...
          link={buildLink('/reports/route-snap')}
          icon={<AddRoadIcon />}
          selected={location.pathname === '/reports/route-snap'}
        />
        <MenuItem
          title={t('reportReplaySnap')}
          link={buildLink('/replay-snap')}
          icon={<RouteIcon />}
        />
        <MenuItem
          title={t('reportTripSnap')}
